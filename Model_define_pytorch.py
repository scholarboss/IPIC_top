...
#             common.NLResAttModuleDownUpPlus(common.default_conv, M, 3),
#         )
#         self.cat1 = nn.Conv2d(in_channels=M, out_channels=M, kernel_size=3, stride=2, padding=1)
...
#             # nn.LeakyReLU(negative_slope=0.3, inplace=True),
#         )
#         self.cat2 = nn.Conv2d(in_channels=M, out_channels=M, kernel_size=3, stride=2, padding=1)
...
#             # nn.Sigmoid()
#         )
#         self.reduct = nn.Conv2d(in_channels=M*3, out_channels=M, kernel_size=1)
...
#         cat2 = self.cat2(out)
#         cat3 = self.enc3(out)
#         cat = torch.cat((cat1, cat2, cat3), 1)
#         out = self.reduct(cat)
...
#         super(Decoder, self).__init__()
#         self.dequantization = DequantizationLayer(B)
#         self.fc1 = nn.Linear(in_chan, 256)
